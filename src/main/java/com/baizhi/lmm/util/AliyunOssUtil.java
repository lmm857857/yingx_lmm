...
public class AliyunOssUtil {
    ...
    private static String accessKeyId = "LTAI4GHypJXuUaSouaBGmFJ1";
    private static String accessKeySecret = "WrsRdSGAj7lbAL5cJMT3m5UxQmLy5I";

    private static String bucket="yingxue-ming";
